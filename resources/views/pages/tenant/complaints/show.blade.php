            ...
            <div class="col-xl-10 mx-auto">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-2">{{ __('app.tenant_complaint_created_at') }}:
                            {{ optional($complaint->created_at)->format('Y-m-d H:i') }}</p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($complaint->admin_reply)
                            <p class="text-muted mb-2">{{ __('app.tenant_complaint_reply_at') }}:
                                {{ optional($complaint->admin_replied_at)->format('Y-m-d H:i') }}</p>
