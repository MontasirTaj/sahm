            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active">تعديل {{ $propertyType->name_ar }}</li>
                    </ol>
                </nav>
                        ...
                        <form action="{{ route('admin.property-types.update', $propertyType) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_ar"
                                    ...
                                    value="{{ old('name_ar', $propertyType->name_ar) }}" required
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_en"
                                    ...
                                    value="{{ old('name_en', $propertyType->name_en) }}" required
                                    placeholder="Example: Residential Apartment">
                                @error('name_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
